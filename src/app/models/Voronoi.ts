...
export class Voronoi implements InterfaceLibrary{
    ...
    mostrarMenu():void {
        ...
        var contenedor= "<div class='row' id='visualizador"+id+"'"+">"+
                        " <div class='container col-sm-10' id='"+id+"'"+"></div> " +
                         "<div class='d-none d-md-block bg-light sidebar col-sm-2' id='menu"+id+"'"+"></div>" +
                         "</div>";
        ...
        $('#menu'+id).append(item);
        $('#menu'+id).css({ "visibility": "visible", "height": "600px", "width": "250" })
        /******************************************************************************** */
        ...
        function setColor(checkbox:any, r:any, g:any, b:any) {
